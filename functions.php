...
function publish_get_footer_credits( $credits = '' ) {
	return sprintf(
		...
		sprintf( __( 'Theme: %1$s by %2$s.', 'publish' ), '<a href="https://github.com/rcsilva83/parrot/">Parrot</a>', '<a href="http://rodrigocarvalho.blog.br/" rel="designer">Rodrigo Carvalho</a>' )
	);
}
